...
assert.strictEqual(utils.binarySearch([10, 20, 30, 40, 50], 5, utils.identity), -1)
assert.strictEqual(utils.binarySearch([10, 20, 30, 40, 50], 99, utils.identity), 4)
assert.strictEqual(utils.binarySearch([10, 20, 30, 40, 50], 11, utils.identity), 0)
assert.strictEqual(utils.binarySearch([[10], [20], [30], [40], [50]], 40, function(e){return e[0]}), 3)
